...
import { Globe, Code, FolderTree, Search, RefreshCw, ChevronLeft, ChevronRight, Plus, Folder, File, ChevronDown } from "lucide-react"
      ...
      <div className="flex-1 min-h-0 rounded-lg border border-border/50 bg-muted/5 overflow-hidden">
        <div className="h-full flex items-center justify-center">
          <div className="text-center space-y-3 max-w-md mx-auto px-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground/80 mb-1">Code Editor</h3>
              <p className="text-sm text-muted-foreground">Create a new file or select an existing one to start coding.</p>
            </div>
            <div className="grid grid-cols-2 gap-3 mt-6">
              <button 
                type="button"
        ...
        <div className="h-full overflow-y-auto p-4">
          <div className="space-y-0.5">
            <div className="flex items-center gap-2 p-2 hover:bg-muted/10 rounded-lg cursor-pointer group">
              ...
              <span className="text-sm text-foreground/80 group-hover:text-primary">Project Root</span>
            </div>
            <div className="ml-4 space-y-0.5 pl-2 border-l border-border/50">
              <div className="flex items-center gap-2 p-2 hover:bg-muted/10 rounded-lg cursor-pointer group">
                <ChevronDown className="h-4 w-4 text-muted-foreground group-hover:text-primary shrink-0" />
                <Folder className="h-4 w-4 text-primary shrink-0" />
                <span className="text-sm text-foreground/80 group-hover:text-primary">src</span>
              </div>
              <div className="ml-4 space-y-0.5 pl-2 border-l border-border/50">
                <div className="flex items-center gap-2 p-2 hover:bg-muted/10 rounded-lg cursor-pointer group">
                  <File className="h-4 w-4 text-muted-foreground shrink-0" />
                  <span className="text-sm text-foreground/80 group-hover:text-primary">index.ts</span>
                </div>
                <div className="flex items-center gap-2 p-2 hover:bg-muted/10 rounded-lg cursor-pointer group">
                  <File className="h-4 w-4 text-muted-foreground shrink-0" />
                  <span className="text-sm text-foreground/80 group-hover:text-primary">types.ts</span>
                </div>
              </div>
              <div className="flex items-center gap-2 p-2 hover:bg-muted/10 rounded-lg cursor-pointer group">
                <File className="h-4 w-4 text-muted-foreground shrink-0" />
                <span className="text-sm text-foreground/80 group-hover:text-primary">package.json</span>
              </div>
              <div className="flex items-center gap-2 p-2 hover:bg-muted/10 rounded-lg cursor-pointer group">
                <File className="h-4 w-4 text-muted-foreground shrink-0" />
                <span className="text-sm text-foreground/80 group-hover:text-primary">README.md</span>
              </div>
            </div>
          </div>
        </div>
